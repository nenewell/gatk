...
public final class FindBreakpointEvidenceSpark extends GATKSparkTool {
    ...
    protected void runTool( final JavaSparkContext ctx ) {
        ...
        final FastqWriter fastqWriter =
                new FastqWriter(locations.alignerIndexImageFile, maxFASTQSize, fastqDir, gfaDir);
    ...
    /** This FASTQHandler aligns assembly contigs with BWA, along with some optional writing of intermediate results. */
